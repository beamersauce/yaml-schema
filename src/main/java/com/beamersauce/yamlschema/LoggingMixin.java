...
/**
 * Attribution: https://github.com/remkop/picocli/blob/master/picocli-examples/src/main/java/picocli/examples/logging_mixin_advanced/LoggingMixin.java
 *
...
public class LoggingMixin {
    ...
    private static LoggingMixin getTopLevelCommandLoggingMixin(CommandSpec commandSpec) {
        return ((YamlSchemaCommand) commandSpec.root().userObject()).loggingMixin;
    }
